...
/*-----------------------------------------------------------------------------------*/
  ...
  $cubelightbox.cubeportfolio({
    ...
    defaultFilter: '.amazing-sri-lanka', // '*' for all
    animationType: 'quicksand',
    gapHorizontal: 15,
    gapVertical: 15,
    gridAdjustment: 'responsive',
  ...
  //                 var mapicon = new google.maps.MarkerImage("assets/images/marker@2x.png", null, null, null, new google.maps.Size(40, 40));
...
/*-----------------------------------------------------------------------------------*/
  ...
  /*
  *** animated text background by Dushan
  */

  var tl = new TimelineMax({ repeat: -1, yoyo: false });

  tl.to(".clip-text", 4, { css: { "background-position": "500px" }, ease: Quad.easeInOut });
