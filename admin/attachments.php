...
ce_admin_head('Attachments');
ce_admin_header('attachments', 'Company Profile Attachment');
?>
...
<?php ce_admin_foot('<script src="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.min.js"></script><script src="admin.js"></script>'); ?>
