...
$vf_config = array(
     ...
     */
    'emailRecipients' => 'info@ceylonenergyservices.com, sales@ceylonenergyservices.com',
     ...
     */
    'emailSender' => 'info@ceylonenergyservices.com'
    /*** /Code Snippet - quick-start ***/
);
...
$subject = 'Ceylon Energy Services - New Message from '.$vfSender->data['name'];

// Define here content of the e-mail message
$content = "Hey,
You've received new message from Ceylon Energy Services website. Check the details below:
